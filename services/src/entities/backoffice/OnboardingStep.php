...
class OnboardingStep
{
	...
	/**
	 * @var \helena\entities\backoffice\Onboarding
	 *
	 * @ClientReadonly
     *
	 * @ORM\ManyToOne(targetEntity="helena\entities\backoffice\Onboarding")
	 * @ORM\JoinColumns({
	 ...
	 * Get onboarding
	 *
	 * @return \helena\entities\backoffice\Onboarding
	 */
	 ...
	 * Set onboarding
	 *
	 * @param \helena\entities\backoffice\Onboarding $onboarding
	 *
	 * @return OnboardingStep
	 */
    public function setOnboarding(\helena\entities\backoffice\Onboarding $onboarding = null)
    {
