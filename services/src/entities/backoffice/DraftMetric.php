 ...
 * DraftMetric
 *
 * @ORM\Table(name="draft_metric", indexes={@ORM\Index(name="draft_fk_layers_layers_groups1_idx", columns={"mtr_metric_group_id"}), @ORM\Index(name="draft_fk_layer_user2_idx", columns={"mtr_update_user_id"})})
 * @ORM\Entity
 */
class DraftMetric
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="helena\entities\backoffice\MetricGroup", fetch="EAGER")
     * @ORM\JoinColumns({
