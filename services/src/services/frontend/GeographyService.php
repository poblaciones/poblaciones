...
class GeographyService extends BaseService
{
	...
	public function GetGeography($geographyId, $x, $y, $z, $b)
	{
		$data = null;
		$key = GeographyCache::CreateKey($x, $y, $z, $b);
		...
		$data = $this->CalculateGeography($geographyId, $x, $y, $z, $b);
	...
	private function CalculateGeography($geographyId, $x, $y, $z, $b)
	{
