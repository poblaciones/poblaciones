...
class SnapshotShapeDatasetItemModel
{
	public function RegenDataset($datasetId)
	{
		...
		$sql = "insert into snapshot_shape_dataset_item(sdi_dataset_id, sdi_dataset_item_id, sdi_feature_id, sdi_geometry_r1, sdi_geometry_r2, sdi_geometry_r3, sdi_geometry_r4, sdi_geometry_r5, sdi_geometry_r6)
						select " . $datasetIdShardified . ", id, 0x100000000 * " .  $datasetIdShardified . " + id, geometry_r1, geometry_r2, geometry_r3, geometry_r4, geometry_r5, geometry_r6 from " . $datasetTable;
