...
class SnapshotMetricVersionModel
{
	...
	public function RegenMetric($metricId, $regenFullTable = false)
	{
		...
		else
		{
	 	...
	 	$sql = "INSERT INTO snapshot_metric_version ( mvw_metric_version_id, mvw_metric_id, mvw_metric_tag, mvw_metric_icon, mvw_metric_revision, mvw_metric_caption, mvw_metric_group_id, mvw_metric_provider_id, `mvw_caption`, mvw_level,
