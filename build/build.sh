...
cp $output/templates/table.html.twig $output/templates/frontend/>>$output-4_copy.log
...
cp $output/templates/packs.html.twig $output/templates/frontend/>>$output-4_copy.log
