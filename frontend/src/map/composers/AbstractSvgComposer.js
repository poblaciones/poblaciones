import AbstractTextComposer from '@/map/composers/AbstractTextComposer';
import h from '@/map/js/helper';
import str from '@/common/framework/str';
import color from '@/common/framework/color';
import PatternMaker from '@/map/composers/PatternMaker';
import SvgMarkerMaker from '@/map/composers/SvgMarkerMaker';
