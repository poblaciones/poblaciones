	...
	<div class="profileMenu">
		<md-menu md-size="medium" md-align-trigger md-direction="bottom-end">
			<md-button class="md-icon-button avatarButton" md-menu-trigger>
				<div class="avatar">
					<img v-if="picture" :src="picture" :alt="displayName" class="avatarImage">
			...
			<md-menu-content>
				...
				<md-menu-item @click="openAccount" class="smallerMenu">
					<md-icon>account_circle</md-icon>
					<span>Detalles de cuenta</span>
				</md-menu-item>
				<md-menu-item v-if="hasWork && Work.CanEdit()" class="smallerMenu" @click="openReview">
					<md-icon>fact_check</md-icon>
					<span>Solicitar revisión</span>
				</md-menu-item>
				<md-divider></md-divider>
				<md-menu-item @click="logoff" class="smallerMenu">
