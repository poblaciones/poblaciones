...
module.exports = {
	build: {
		...
		indexPacks: path.resolve(__dirname, '../../build/release/templates/packs.html.twig'),
		indexCredentials: path.resolve(__dirname, '../../build/release/templates/credentials.html.twig'),
		indexTable: path.resolve(__dirname, '../../build/release/templates/table.html.twig'),
		main: path.resolve(__dirname, '../src/map/main.js'),
		mainBackoffice: path.resolve(__dirname, '../src/backoffice/main.js'),
		mainAdmin: path.resolve(__dirname, '../src/admins/main.js'),
		mainPacks: path.resolve(__dirname, '../src/packs/main.js'),
