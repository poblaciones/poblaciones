...
var config = require('../config/tran-index.js');
...
proxyTable = { '/services': php, '/logs': php, '/static/css': php, '/ark:/': php, '/static/js': php, '/static/vendor': php, '/authenticate': php };
...
app.use(function(req, res, next) {
   if (req.url === '/users/' || req.url === '/users') {
	...
	if (req.url === '/packs/' || req.url === '/packs') {
		req.url = '/packs.html';
	}
...
var vuejsPaths = ['/map/', '/cr', '/users/', '/packs', '/table', '/users', '/static/img', '/admins', '/__webpack_hmr'];
